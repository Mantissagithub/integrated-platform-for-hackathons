    ...
    >
      ...
      <div className="w-1/2 h-full flex flex-col items-center justify-center p-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {[
            { src: 'https://media.istockphoto.com/id/1318360204/photo/team-meeting-and-brainstorming-in-modern-office.jpg?s=2048x2048&w=is&k=20&c=SkzLULKbTDf6U5jVN6DnjtnkYyV_jalx3hH5kg8yJ8E=', alt: 'Team brainstorming', icon: Briefcase },
            { src: 'https://images.unsplash.com/photo-1521737852567-6949f3f9f2b5?q=80&w=2047&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', alt: 'Coding session', icon: Lock },
            { src: 'https://plus.unsplash.com/premium_photo-1661775083116-3e8fbb1d5a7b?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', alt: 'Design review', icon: Mail },
            { src: 'https://media.istockphoto.com/id/1333390966/photo/diverse-employees-on-online-conference-video-call-on-tv-screen-in-meeting-room.jpg?s=2048x2048&w=is&k=20&c=zOKo0bgrIYhxO4KQouyhslGItFB9Cx8UxDiY_8_0MfQ=', alt: 'Project presentation', icon: User },
      ...
      <div ref={formRef} className="w-1/2 h-full flex items-center justify-center bg-white/10 backdrop-blur-md">
        <div className="w-3/4 max-w-md p-8 rounded-xl shadow-2xl">
          <h2 className="text-3xl font-bold mb-6" style={{ color: colors.primary }}>Create your account</h2>
          <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
            <AnimatePresence>
              {[
                { name: 'name', icon: User, placeholder: 'John Doe' },
                { name: 'email', icon: Mail, placeholder: 'john@example.com' },
                { name: 'password', icon: Lock, placeholder: '••••••••' },
                { name: 'confirm-password', icon: Lock, placeholder: '••••••••' },
